function [model] = Sten2023_v21_syms()
...
model.sym.xdot(21) = f0-(1/vis1)*(((K1 -(V1/V1ss))/(K1-1)) + stim_circ - 2*(V1/(C1ss*((R1+R2)*f1+(R2+R3)*f2+R3*f3))))-f1;% f1 - Arterial CBF
model.sym.xdot(22) = f1-(1/vis2)*(((K2 -(V2/V2ss))/(K2-1))             - 2*(V2/(C2ss*((R2+R3)*f2+R3*f3))))-f2;           % f2 - Capillary CBF
model.sym.xdot(23) = f2-(1/vis3)*(((K3 -(V3/V3ss))/(K3-1))             - 2*(V3/(C3ss*(R3*f3))))-f3;                      % f3 - Venous CBF
